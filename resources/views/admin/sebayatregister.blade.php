            ...
            <div class="col-lg-12 col-md-">
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        {{-- <div class="row">
                            <input type="hidden" class="form-control" id="" name="userid"
                                value="JA{{ rand(1000, 9999) }}" placeholder="Enter First Name">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="phonenumber"
                                        value="+91" placeholder="Phone Number">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="bloodgrp"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fathername" id="exampleInputEmail1"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mothername"
                                        id="exampleInputPassword1" placeholder="Enter Mother's Name">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <label class="rdiobox"><input name="marital" type="radio"> <span>Married
                                                </span></label>
                                        </div>
                                        <div class="col-lg-6 ">
                                            <label class="rdiobox"><input checked name="marital" type="radio">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="spouse" id="exampleInputPassword1"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="childrenname[]"
                                            id="exampleInputPassword1" placeholder="Enter Children name">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group  mt-4">
                                        <button type="button" class="btn btn-primary add_item_btn" id="addInput">Add
                                            More</button>
                                    </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="idnumber[]"
                                            id="exampleInputPassword1" placeholder="Enter Number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="uploadoc[]"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary add_item_btn" id="adddoc">Add
                                        More</button>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="preaddress" id="preaddress"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prepost" id="prepost"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="predistrict"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prestate" value="Odisha"
                                                id="prestate" placeholder="Enter State">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="precountry">Country</label>
                                            <input type="text" class="form-control" name="precountry" value="India"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prepincode" id="prepincode"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prelandmark"
                                                id="prelandmark" placeholder="Enter Landmark">
                                        </div>
                                    </div>
                                </div>
                                <label class="ckbox"><input type="checkbox" id="same"
                                        onchange="addressFunction()"> <span class="mg-b-10">Same as Present
                                        Address</span></label>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="perpost" id="perpost"
                                                placeholder="Enter Post">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="perdistri" id="perdistri"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="perstate" id="perstate"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="percountry" id="percountry"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="perpincode" id="perpincode"
                                                placeholder="Enter Pincode">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="perlandmark"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bankname" id="exampleInputEmail1"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="branchname"
                                        id="exampleInputPassword1" placeholder="Enter Branch Name">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ifsccode"
                                        id="exampleInputPassword1" placeholder="Enter IFSC Code">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Account Holder Name</label>
                                    <input type="text" class="form-control" name="accname" id="exampleInputEmail1"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="accnumber"
                                        id="exampleInputPassword1" placeholder="Enter Account Number">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="exampleInputEmail1" name="datejoin"
                                        placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Bedha Seba</label>
                                    <input type="tetx" class="form-control" id="exampleInputPassword1"
                                        name="bedhaseba" placeholder="Enter Bedha Seba">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="seba"
                                        placeholder="Enter Type of Seba">
                                </div>
                                {{-- <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="templeid" class="form-control" id="exampleInputEmail1"
